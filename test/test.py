...
run("sudo ../src/zebr0-lxd delete -u http://localhost:8000 -l project stage")

# test creating and running a container (twice, for idempotence)
run("sudo ../src/zebr0-lxd create -u http://localhost:8000 -l project stage")
run("sudo ../src/zebr0-lxd create -u http://localhost:8000 -l project stage")
...
run("sudo ../src/zebr0-lxd start -u http://localhost:8000 -l project stage")
run("sudo ../src/zebr0-lxd start -u http://localhost:8000 -l project stage")
...
run("sudo ../src/zebr0-lxd stop -u http://localhost:8000 -l project stage")
run("sudo ../src/zebr0-lxd stop -u http://localhost:8000 -l project stage")
